...
#define PANDA_REQUEST_ARM_WAKE_OBSERVER 0xECU
#define PANDA_REQUEST_DISARM_WAKE_OBSERVER 0xEDU
...
#define WAKE_ACTIVE_CAN_EXTI_OBSERVER_ARMED 0x001U
#define WAKE_ACTIVE_CAN_EXTI_IMR_ENABLED 0x002U
#define WAKE_ACTIVE_CAN_EXTI_RISING_ENABLED 0x004U
#define WAKE_ACTIVE_CAN_EXTI_FALLING_ENABLED 0x008U
#define WAKE_ACTIVE_CAN_EXTI_NVIC_ENABLED 0x010U
#define WAKE_ACTIVE_CAN_EXTI_MAPPING_OK 0x020U
#define WAKE_ACTIVE_CAN_EXTI_IRQ_SEEN 0x040U
#define WAKE_ACTIVE_CAN_EXTI_PRIMARY_PENDING 0x080U
#define WAKE_ACTIVE_CAN_EXTI_ARM_LEVEL_HIGH 0x100U
#define WAKE_ACTIVE_CAN_EXTI_IRQ_LEVEL_HIGH 0x200U
#define WAKE_ACTIVE_CAN_EXTI_GPIO_MODE 0x400U
...
#define WAKE_JOURNAL_RECORD_CHECKPOINT 3U
...
#define WAKE_JOURNAL_SOURCE_CAN_PRIMARY 6U
#define WAKE_JOURNAL_SOURCE_PANDA_FAULT 7U

#define WAKE_MONITOR_STATUS_FLAG_RX_ARMED (1U << 0U)
#define WAKE_MONITOR_STATUS_FLAG_PREPARE_DIRTY (1U << 1U)
#define WAKE_MONITOR_STATUS_FLAG_CAN_HEALTHY (1U << 2U)
