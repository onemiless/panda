...
static void enter_stop_mode(void) {
  ...
  // disable DTS before entering deep STOP; wake exits through reset
  register_clear_bits(&(DTS->CFGR1), DTS_CFGR1_TS1_START);
  register_clear_bits(&(DTS->CFGR1), DTS_CFGR1_TS1_EN);
  register_set(&(DTS->CFGR1), 0U, (DTS_CFGR1_TS1_SMP_TIME_Msk | DTS_CFGR1_REFCLK_SEL_Msk | DTS_CFGR1_Q_MEAS_OPT_Msk |
